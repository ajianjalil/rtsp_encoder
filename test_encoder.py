...
class Decoder(multiprocessing.Process):
    ...
    def run(self):
        ...
        factory = SensorFactory(codec=self.codec,udp_port=self.udp_port)
        factory.set_shared(True)
        self.server.get_mount_points().add_factory("/video2", factory)
...
if __name__ == '__main__':
    ...
    de_obj = DecoderEncoder(Address='1.mp4',index=1,port=9000)
    while True:
